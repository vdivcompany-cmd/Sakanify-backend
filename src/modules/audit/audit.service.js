 ...
 *
 * @param {Object} params
 * @param {string} params.actor - User id of whoever performed the action
 ...
 */
async function writeAuditLog({ actor, action, entityType, entityId, beforeState = null, afterState = null }) {
  if (!actor || !action || !entityType || !entityId) {
    throw new AppError('writeAuditLog requires actor, action, entityType, and entityId', 400);
  }
